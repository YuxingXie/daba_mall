        ...
        <div class="row margin-bottom-40">
                <div class="col-md-10 col-sm-10 btn-group btn-group-xs">
                        <button class="btn btn-primary btn-small" ng-click="toSort('sales');">
                                销量排序<i ng-class="{'fa':true,'fa-sort-desc':!sort.asc&&sort.field=='sales','fa-sort-asc':sort.asc&&sort.field=='sales','fa-sort':sort.field!='sales'}"></i></button>
                        <button class="btn btn-primary btn-small" ng-click="toSort('price');">
                            价格排序<i ng-class="{'fa':true,'fa-sort-desc':!sort.asc&&sort.field=='price','fa-sort-asc':sort.asc&&sort.field=='price','fa-sort':sort.field!='price'}"></i></button>
                        <button class="btn btn-primary btn-small" ng-click="toSort('evaluate');">
                            评论排序<i ng-class="{'fa':true,'fa-sort-desc':!sort.asc&&sort.field=='evaluate','fa-sort-asc':sort.asc&&sort.field=='evaluate','fa-sort':sort.field!='evaluate'}"></i></button>
                </div>
