...
<%--&lt;%&ndash;<c:if test="${empty sessionScope.loginUser}">&ndash;%&gt;--%>
    <%--&lt;%&ndash;<script type="text/javascript" src="http://qzonestyle.gtimg.cn/qzone/openapi/qc.js" data-appid="APPID"></script>&ndash;%&gt;--%>
...
<%--//                                window.location.reload();--%>
                                <%--var str='<li>欢迎您,<a href="${path}/personal_message">'+data.name+'</a>!</li><li><a href="#" id="logout">退出</a></li>';--%>
                                <%--$("#commonLogin").html(str);--%>
                            <%--})--%>
