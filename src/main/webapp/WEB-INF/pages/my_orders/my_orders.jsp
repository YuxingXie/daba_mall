...
<div class="container" ng-app="myOrdersApp" id="myOrdersAppMain">
        ...
        <div class="table-responsive">
            <table class="table table-hover table-bordered table-striped" ng-controller="myOrdersController">
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <c:forEach var="order" items="${orders}" varStatus="selectedIndex">
                            <tr class="margin-top-10">
                                ...
                                <td><a href="javascript:void(0)" data-toggle="modal" data-target="#orderDetail">查看详情</a>
                                    <c:choose>
