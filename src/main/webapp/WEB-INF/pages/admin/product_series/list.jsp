...
<div ng-controller='ProductSeriesListController'>
    ...
    <div class="row form-inline font-size-13-5" ng-if="categories.length">
        ...
        <div class="col-sm-7 col-lg-7 input-group">
            <input type="text" placeholder="产品名" class="form-control pull-left padding-left-0"/>
            <span class="input-group-btn"><button class="btn btn-primary">搜索产品</button></span>
        </div>
    </div>
        ...
        <table class="table table-hover">
            ...
            <tr ng-repeat="productSeries in list">
                ...
                <td class="font-size-12 btn-group btn-group-xs">
                    ...
                    <a href="#" class="btn btn-primary"><i class="fa fa-cubes"></i>调整库存</a>
                    <a href="#" class="btn btn-primary"><i class="fa fa-paperclip"></i>调整分类</a>
                </td>
            </tr>
        </table>
    </div>
