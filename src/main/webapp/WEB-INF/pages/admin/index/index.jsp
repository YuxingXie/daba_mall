...
<div class="container" ng-controller="AdminIndexController">
    ...
    <div class="row margin-top-20">
        <i class="fa fa-volume-up fa-fw"></i>消息<a  ng-if="data.notifies" href="${path}/admin/notify/list"><i class="color-red">({{data.notifies}})</i></a>
    </div>
    <div class="row margin-top-20">
    ...
    <%--</div>--%>
    <div class="row margin-top-20">
        <i class="fa fa-list-ul"></i>退换货订单<a ng-if="data.returnOrders" href="${path}/admin/order/return_exchange"><i class="color-red">({{data.returnOrders}})</i></a>
    </div>
    <div class="row margin-top-20">
