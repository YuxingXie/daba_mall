...
angular.module('pagesData', [])
  ...
  "api/ng/service/$animate": {
    ...
    "searchTerms": {
      "titleWords": "$animate",
      "keywords": "$animate $animator adding angularjs animate animation api classes click core css dom elements enable enabling full function high-level hooks included insert javascript js js-angular-release learn manipulation module move ng nganimate operations perform remove removing rudimentary service simple src support visit"
    }
  },
  ...
  "api/ng/type/$compile.directive.Attributes": {
    ...
    "searchTerms": {
      ...
      "keywords": "$compile angular api attributes binding compile current data-ng-bind directive dom element equivalent function js js-angular-release linking needed ng ng-bind ng:bind nodesetlinkingfn normalization normalized object reflect shared src treated type values x-ng-bind"
    }
  },
  "api/ng/provider/$controllerProvider": {
    ...
    "searchTerms": {
      ...
      "keywords": "$handler $controllerprovider allows angular api handler controllers create js js-angular-release method ng provider register registration service src"
    }
  },
  "api/ng/service/$controller": {
    "docType": "service",
    "id": "module:ng.service:$handler",
    "name": "$controller",
    "area": "api",
    "outputPath": "partials/api/ng/service/$handler.html",
    "path": "api/ng/service/$handler",
    "searchTerms": {
      "titleWords": "$controller",
      "keywords": "$handler $controllerprovider $injector api auto call called check considered handler controllers current evaluating extracted function github global injection instance instantiating js js-angular-release locals ng object override registered responsible retrieve returns scope service simple src steps string version window"
    }
  },
  "api/ng/directive/a": {
    "docType": "directive",
  ...
  "api/ng/directive/ngForm": {
    ...
    "searchTerms": {
      ...
      "keywords": "alias allow api capabilities handler controls determined directive eac elements example form formdirectivefactory forms group html js js-angular-release nest nestable nesting ng ngform note posting published purpose replacement scope server src sub-group tag validity"
    }
  },
  ...
  "api/ng/directive/ngController": {
    ...
    "searchTerms": {
      "titleWords": "ngController handler",
      "keywords": "$route $scope access accessed accessible accessing adding advantages angular api appear application apply aspect attach attached attaches automatically avoiding binding bindings binds boilerplates business called changes class classes clearing code common community components contact handler controllers current data declaration declare declared declaring decorate definition demonstrates design directive directly dom don easier easily editing element evaluates example example-ngcontroller example-ngcontrolleras executed expression form function function generally globally greeting guide included inheritance injects inside instance js js-angular-release key logic manual markup masking methods mistake model model-view-handler models multiple mvc ng ng-handler ngcontroller ngcontrollerdirective ngroute note obvious option pattern primitives principles properties property propertyname prototypal published reflected removing rendered route scope scopes second service settings settingscontroller1 settingscontroller2 simple source specifies src style styles supports syntax tab template update user values view worry writing"
    }
  },
  ...
  "api/ngMock/function/angular.mock.module": {
    ...
    "searchTerms": {
      ...
      "keywords": "access aliases angular angular-mocks anonymous api automatically code collects configuration configure created easy example fns function function initialization inject injector js js-angular-release key literal loaded mock module modules ng ngmock number object passed published registered registers represented returned src string usage values window"
    }
  },
  ...
  "api/ngTouch/service/$swipe": {
    ...
    "searchTerms": {
      "titleWords": "$swipe",
      "keywords": "$swipe abstracts api behavior bind component convenient details directives documentation element factory function handler hold-and-drag implementing installed js js-angular-release messier method module ngcarousel ngswipeleft ngswiperight ngtouch object requires separate service single src swipe swipe-related swipes takes usage watched"
    }
  },
  "api/ngTouch": {
    "docType": "module",
  ...
  "error/$controller/noscp": {
    ...
    "name": "noscp",
    "area": "error",
    "outputPath": "partials/error/$handler/noscp.html",
    "path": "error/$handler/noscp",
    "searchTerms": {
      "titleWords": "$controller:noscp",
      "keywords": "$handler $scope api call called consult handler docs error example incorrect instantiate js-angular-release leads learn locals map missing newscope ng ngdoc noscp object occurs order property provide provided scope service usage"
    }
  },
  ...
  "error/$injector/cdep": {
    ...
    "searchTerms": {
      ...
      "keywords": "$injector angular cdep chain circular construct handler created dependencies dependency depends detect directly docs error example factory function guide indirectly injection injector instance js-angular-release module myapp myctrl myservice ngdoc occurs service throw"
    }
  },
  "error/$injector/itkn": {
    "docType": "error",
    ...
    "searchTerms": {
      ...
      "keywords": "$http $inject $injector $scope $timeout annotation annotations avoid bad code handler dependency docs error example examples explanation function guide include injection itkn js-angular-release literals myappmodule myctrl ngdoc occurs refer second string strings thrown token tokens type var"
    }
  },
  ...
  "error/$injector/unpr": {
    ...
    "searchTerms": {
      ...
      "keywords": "$injector angular code handler correctly defined dependency docs error example fail function js-angular-release making module myapp mycontroller myservice ngdoc problem provider required resolve service spelled unable unknown unpr"
    }
  },
  ...
  "error/$parse/isecff": {
    ...
    "searchTerms": {
      ...
      "keywords": "$parse access angular apply attempts avoid bans behaviour bind call disallowed docs error example existing expression expressions function function invocation invoke isecff js-angular-release methods modify ngdoc occurs referencing resolve result sendinfo true"
    }
  },
  "error/$parse/isecfld": {
    "docType": "error",
  ...
  "error/$parse/isecfn": {
    ...
    "searchTerms": {
      ...
      "keywords": "$parse access angular arbitrary attempts avoid bans code disallowed docs error execute expression expressions function function isecfn javascript js-angular-release ngdoc object occurs referencing resolve"
    }
  },
  ...
  "guide/databinding": {
    ...
    "searchTerms": {
      ...
      "keywords": "additional angular application apps automatic automatically bind binding browser change changes class classical code compilation compiled completely components constantly handler data data-binding databinding dependency developer differently direction directives docs dom easy greatly guide html img implements instant isolation js-angular-release live markup merge model ngdoc occurs overview png produces programming projection propagated reflected reflects scope scopes sections separated simplifying simply single-source-of-truth snap src step synchronization syncs systems template templates templating test testing times topics treat unaware uncompiled user versa vice view work worse write"
    }
  },
  "guide/di": {
    "docType": "overview",
  ...
  "guide/expression": {
    ...
    "searchTerms": {
      ...
      "keywords": "$eval $event $location $parse $rootscope $window access accidental angular apart application binding bindings bugs call called clickme clutter code common complex conditional conditionals context control handler controllers core data defined delegate differences directive directives displaying docs document eval evaluate evaluated evaluating evaluation evaluations example example-example90 example-example91 example-example92 example-example93 exception exceptions expose expression expressions filters flow forgiving format function function general generates global globals guide intentional invoking items javascript javascript-like js-angular-release language location logic loop loops method mockable ng ngclick ngdoc ngfocus note null object operator overview pass philosophy prevents processes properties provide purpose real reason referenceerror response restriction returns scope sense server service services simply snippets source statement statements subtle ternary throw throws typeerror undefined user valid variables view views waiting wasn window write"
    }
  },
  "guide/filter": {
    "docType": "overview",
  ...
  "controller.js": {
    "docType": "example-js",
    "id": "example-multi-bootstrap/handler.js",
    "outputPath": "examples/example-multi-bootstrap/handler.js",
    "path": "controller.js"
  },
  "protractor.js": {
  ...
  "error/$controller": {
    ...
    "name": "$controller",
    "area": "error",
    "outputPath": "partials/error/$handler.html",
    "path": "error/$handler"
  },
  "error/$httpBackend": {
    "docType": "errorNamespace",
