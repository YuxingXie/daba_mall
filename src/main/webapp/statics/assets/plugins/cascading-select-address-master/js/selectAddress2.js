// Generated by CoffeeScript 1.7.1
  mainApp.directive('selectAddress', function($http, $q, $compile) {
      var cityURL, delay, templateURL;
      delay = $q.defer();
      templateURL =path+ '/statics/assets/plugins/cascading-select-address-master/template/index.html';
      cityURL = path+'/statics/assets/plugins/cascading-select-address-master/template/city.min.js';
      $http.get(cityURL).success(function(data) {
        return delay.resolve(data);
      });
      return {
        restrict: 'A',
        scope: {p: '=',a: '=',c: '=',d: '=',ngModel: '='},
 ...
 .controller('toBillAppCtrl', function($scope) {
    $scope.p = '';
    $scope.c = '';
    $scope.a = '';
    return $scope.d = '';
